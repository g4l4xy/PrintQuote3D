...
let package = Package(name: "PrintQuote3D", platforms: [.macOS(.v14), .iOS(.v17)], products: [.library(name: "QuoteDomain", targets: ["QuoteDomain"]), .library(name: "QuoteData", targets: ["QuoteData"]), .library(name: "OrcaProfiles", targets: ["OrcaProfiles"]), .executable(name: "PrintQuote3D", targets: ["PrintQuoteApp"]), .executable(name: "OrcaProfileImporter", targets: ["OrcaProfileImporter"])], dependencies: [.package(url: "https://github.com/weichsel/ZIPFoundation.git", exact: "0.9.20")], targets: [
