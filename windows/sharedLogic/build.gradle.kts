...
kotlin {
 ...
 sourceSets.main {
  ...
  kotlin.include("local/printquote/windows/**", "local/printquote/android/model/Documents.kt", "local/printquote/android/pricing/PricingEngine.kt", "local/printquote/android/data/WorkspaceRepository.kt")
 }
}
...
sourceSets.test { java.srcDir("../../android/app/src/test/java"); java.include("**/ParityTests.kt") }
